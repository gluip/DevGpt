...
namespace MyApp // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            var ramMemoryManager = new RamMemoryManager();
            var client = new AzureOpenAIClient(ramMemoryManager);
            var chatHandler = new ChatHandler(ramMemoryManager);
            ...
            chatHandler.AddMessage(new ChatMessage(ChatRole.System, fullPrompt));
            ...
            while (true)
            {
                ...
                {
                    chatHandler.AddMessage(new ChatMessage(ChatRole.User, $"Unable to parse the response as json. Please provide a proper formatted respose.Error : "+e.Message));
