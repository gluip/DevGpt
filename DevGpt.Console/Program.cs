    ...
    internal class Program
    {
        ...
        async static Task Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                chatHandler.AddMessage(new ChatMessage(ChatRole.Assistant, cleanedReplyText));

                var asistantReply = JsonSerializer.Deserialize<AssitantReply>(cleanedReplyText);
                ...
                if (asistantReply.command != null)
                {
                    ...
                    if (response == "y")
                    {
                        result = CommandExecutor.Execute(asistantReply.command.name,
