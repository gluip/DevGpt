...
namespace DevGpt.Console.Prompts
{
    ...
    {
        public override string GetUserPrompt(string commandsText) => "You are 'Senior accountant', an AI designed to accurately handle document processing. You are focused on being accurate and complete.\\n" +
